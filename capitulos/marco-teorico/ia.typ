...
Los modelos de lenguaje han sido uno de los principales puntos de encuentro entre la inteligencia artificial (IA) y el procesamiento del lenguaje natural (PLN): son el instrumento con el que el PLN representa y genera el lenguaje humano. Su historia puede leerse como un retiro gradual: cada generación de modelos usó menos reglas escritas por lingüistas y más estadística, hasta que el conocimiento lingüístico explícito desapareció del diseño. Esta sección recorre esa historia para ubicar el único punto del proceso donde todavía se toma una decisión sobre la estructura del texto antes de que el modelo aprenda nada: la unidad mínima sobre la que operan los modelos actuales.

Los primeros sistemas de PLN modelaron la lengua mediante reglas gramaticales explícitas, con una fuerte influencia lingüística: desde el experimento Georgetown-IBM @hutchins-2004-georgetown, una de las primeras demostraciones de traducción automática, que empleó apenas 6 reglas, hasta arquitecturas más elaboradas como EUROTRA @johnson-etal-1985-eurotra @varile-lau-1988-eurotra, que analizaba sintáctica y semánticamente la lengua de origen para transferir esa representación a la lengua destino. En ambos casos, construir un modelo funcional exigía un intenso trabajo lingüístico; ese costo fue, a la larga, la razón de su abandono.
