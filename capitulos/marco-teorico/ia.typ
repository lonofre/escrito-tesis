...
La tokenización puede verse como el proceso de segmentar las cadenas de texto en unidades más fundamentales. Estas unidades son convertidas después a representaciones numéricas (vectores/embeddings) que sirven para entrenar una red neuronal artificial. Un modelo del lenguaje no aprende cuáles son las unidades más apropiadas en las que se debe segmentar una cadena en lenguaje natural. Más bien, la tokenización es un proceso aparte que tiene mucho impacto en el desempeño del sistema final.
