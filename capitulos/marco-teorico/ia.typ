...
La tokenización puede verse como el proceso de segmentar las cadenas de texto en unidades más
fundamentales, estas unidades son convertidas después a representaciones numéricas (vectores/embeddings) que sirven para entrenar una red neuronal artificial. Un modelo del lenguaje no
aprende cuáles son las unidades más apropiadas en qué se debe segmentar una cadena en lenguaje natural, más bien, la tokenización es un proceso a parte que tiene mucho impacto en el desempeño del sistema final.
