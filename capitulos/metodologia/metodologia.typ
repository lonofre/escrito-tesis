...
Nuestra hipótesis dice que, si las lenguas se agrupan de forma parecida en el espacio de BPE y en los espacios construidos a partir de las bases de datos lingüísticas, entonces BPE captura parte de la estructura que describen los lingüistas. Para ponerla a prueba, representamos cada fuente de la misma manera: como un espacio donde representamos a las lenguas mediante características, sin importar si esas características vienen de contar subpalabras o de las descripciones realizadas por lingüistas. Sobre esos espacios agrupamos a las lenguas y medimos qué tanto coinciden los agrupamientos.

#let footnote_repo = [
  El código y los datos de los experimentos se encuentran en
