...
Por otro lado, decidir cuántas y cuáles características de Grambank utilizar fue una decisión que tuvimos que resolver nosotros mismos, pues no contábamos con un criterio claro para hacerlo. En primer lugar, esto se debe a que el número de características con un valor definido varía de una lengua a otra. En algunas lenguas, una característica puede tener un valor de 0 o 1; en otras, aparece marcada con el símbolo "?"; y en otras más, no se registra ningún valor para esa característica. Debido a esta diferencia en la cobertura, cada lengua termina teniendo una cantidad distinta de características con valores definidos. Por ejemplo, el inglés (eng) cuenta con 195 características con valores definidos, mientras que el barasano (bsn) solo cuenta con 65. En segundo lugar, a diferencia de WALS, Grambank no agrupa sus características por área lingüística, lo cual nos habría proporcionado un criterio de selección sin necesidad de contar con conocimiento lingüístico especializado.
