...
lang2vec @littell2017uriel #footnote(lang2vec_footnote) es una biblioteca que proporciona representaciones vectoriales tipológicas de lenguas, integrando información de varias bases de datos lingüísticas (WALS, PHOIBLE, Ethnologue, Glottolog, entre otras). La usamos por sus conjuntos de características sintácticas, que contrastan con las características de tipología morfológica que seleccionamos de WALS.
