...
La banda de $X_G$ vs $X_W$ se sitúa por encima de la de cualquier comparación con $X_"BPE"$. Su rango intercuartil se mantiene en valores positivos. El primer cuartil ronda $0.01$–$0.02$ y el tercero, $0.09$–$0.12$, con una mediana entre $0.041$ y $0.066$. El techo, medido por el percentil 99, va de $0.25$ a $0.29$, sin que el percentil 1 baje de $-0.075$, y el máximo real sube todavía más, entre $0.37$ y $0.53$, con su pico en $d_G = 30$.
...
#figure(
  table(
    ...
    [BPE vs Grambank],      [$0.009$–$0.026$], [$0.28$], [$0.24$–$0.49$],
